...
const estadisticas = [
  { numero: "+500", texto: "Medicos verificados" },
  { numero: "+30", texto: "Especialidades" },
  { numero: "24/7", texto: "Atencion disponible" },
];

// Tarjetas informativas del panel derecho
const tarjetasInfo = [
  { icono: "schedule", titulo: "Proxima cita disponible", detalle: "En 15 minutos", color: "text-primary bg-primary-subtle" },
  { icono: "video_chat", titulo: "Telemedicina", detalle: "Disponible ahora", color: "text-success bg-success-subtle" },
  { icono: "star", titulo: "Calificacion promedio", detalle: "4.9 / 5.0", color: "text-warning bg-warning-subtle" },
];
        ...
        <div className="row align-items-center g-5">
          ...
          <div className="col-md-6">
            ...
            <p className="lead text-secondary my-4">
              ...
              y recibe atencion medica de calidad sin salir de casa.
            </p>
            ...
            <div className="d-flex flex-column flex-sm-row gap-3 mb-4">
              ...
              {/* El registro de medicos tiene su propio formulario */}
              <Link to="/registro-doctor" className="btn btn-outline-secondary btn-lg">
                Eres medico? Registrate
              </Link>
            </div>
          ...
          <div className="col-md-6 d-none d-md-block">
            <div className="card border-0 shadow-lg rounded-4 p-4">
              ...
              <div className="text-center mb-4">
                <p className="fs-5 fw-bold mb-0">Atencion medica confiable</p>
